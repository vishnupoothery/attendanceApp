...
<html lang="en">
  ...
  <head>
    ...
    <title>Pulse Admin - Add Exam</title>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <!--  Buttons  -->
            <div class="box-btn">
              <a href="addRanklist.php" class="btn btn-outline-dark btn-bread"> Add Result </a>
              <a class="btn btn-dark btn-bread"> View Result </a>
            </div>
          <!-- DataTables Example -->
          <div class="card mb-3">
            <div class="card-body">
              <div class="row">
                <?php
                $count = 1;
                foreach($conn->query('SELECT * FROM batch WHERE old = 0 ORDER BY batchName ASC') as $row){
                  echo '<div class="col-1 btn btn-link">'.$count.'</div><div class="col-11 "><a class="btn btn-link" href="viewRankListAddedBatch.php?batch='.$row['id'].'">'.$row['batchName'].'</a></div>';
                $count+=1;
                }
                ?>
              </div>
