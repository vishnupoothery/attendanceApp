<?php
  ...
  $records = $conn->prepare('SELECT * FROM student WHERE rollNo = :rollNo');
  $records->bindParam(':rollNo', $_GET['rollNo']);
  $records->execute();
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="viewBatch.php?batchId=<?php echo $batch['id']; ?>"><?php echo $batch['batchName']; ?></a></li>
          ...
          <div class="card mb-3">
            <div class="card-body">
              <div class="">
                <div class="row">
                  <div class="col-12 col-md-3"><img class="img-fluid" src="<?php echo $student['picture'] ?>"></div>
                </div>
                <div class="row">
                  ...
                  <div class="col-9">: <?php echo $student['father'] ?></div>
                  <div class="col-12"><hr style="color:white;"></div>
                  <div class="col-3">Roll No </div>
                  <div class="col-9">: <?php echo $student['rollNo'] ?></div>
                  <div class="col-12"><hr style="color:white;"></div>
                  <div class="col-3">Date of Birth </div>
                  <div class="col-9">: <?php echo $student['dob'] ?></div>
                  <div class="col-12"><hr style="color:white;"></div>
                  <div class="col-3">Batch </div>
                  <div class="col-9">: <?php echo $batch['batchName'] ?></div>
                  <div class="col-12"><hr style="color:white;"></div>
                  <div class="col-12 text-center"><br>
                <a class="btn btn-outline-dark" href="addStudent.php"> OK </a></div>
                </div>
              </div>
            </div>
          </div>
