      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="box-btn">
              ...
              <a class="btn btn-outline-dark btn-bread" href="editAttendance.php?batch=<?php echo $_GET['batch'] ?>&&date=<?php echo $_GET['date'] ?>"> Edit </a>
              <a class="btn btn-outline-dark btn-bread" href="deleteAttendance.php?batch=<?php echo $_GET['batch'] ?>&&date=<?php echo $_GET['date'] ?>"> Delete </a>
            </div>
          <!-- DataTables Example -->
          <div class="card mb-3">
            <div class="card-body">
