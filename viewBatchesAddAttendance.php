    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!--  Buttons  -->
          <div class="box-btn">
              <a class="btn btn-dark btn-bread"href="addNotification.php" > Add Attendance </a>
              <!--
                <a class="btn btn-dark btn-bread"> View Notification </a>
              -->
            </div>
          <!-- DataTables Example -->
          <div class="card mb-3">
            <div class="card-body">
              <div class="row">
                ...
                foreach($conn->query('SELECT * FROM batch WHERE old = 0 ORDER BY batchName ASC') as $row){
                  echo '<div class="col-1 col-md-1 btn btn-link">'.$count.'</div><div class="col-11"><a class="btn btn-link" href="addAttendance.php?batchId='.$row['id'].'">'.$row['batchName'].'</a></div>';
